...
class StateAnalyzer:        
    def __init__(self, max_values=100, tolerance=0.2, tolerance_multipler=2):
        ...
        self._current_state = states.learning
    ...
    def update(self, value):
        ...
        if self._current_state == states.learning:
        ...
        # TODO add tolerances
        self._current_state = states.normal if value < self._normal_state + self._normal_state*self._tolerance\
            else states.anomaly

        # self._current_state = States.normal if value < self._normal_state + self._tolerance_multiplier*stdev(self._values)\
        #     else States.anomaly
